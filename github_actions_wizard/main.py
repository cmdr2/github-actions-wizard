...
def add_build_job(workflow):
    ...
    if build_type == "dummy":
        add_dummy_build_step(workflow)
    elif build_type == "hugo":
        add_hugo_build_step(workflow)


def add_dummy_build_step(workflow):
...
def add_hugo_build_step(workflow):
    workflow.add_checkout_step("build")
    ...
    workflow.add_job_shell_step("build", "hugo --minify", name="Build")
    workflow.add_job_step(
        "build",
        **{
